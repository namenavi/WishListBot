...
{
    /// <summary>
    /// Класс, который представляет команду отмены назначения исполнителя для своего желания
    /// </summary>
    public class CancelWishCommand : IRequest
    {
        /// <summary>
        ...
        public CancelWishCommand(int wishNumber)
        {
            if(wishNumber <= 0)
            {
